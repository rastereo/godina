    ...
    <main className="presentation">
      ...
      <figure>
        ...
        <figcaption className="presentation__description">
          «Вид из окна в Ле Гра» (фр. Point de vue du Gras) — первая из дошедших до наших дней гелиогравюр.
          Считается первой в мире фотографией, снятой с натуры. Создана французским изобретателем Жозефом
          Нисефором Ньепсом в 1826 (по другим данным — в 1827) году на пластинке, покрытой слоем битума.
          <a
      ...
      <p className="presentation__instruction">
        Добро пожаловать в игру, посвященную почти двухсотлетней истории фотографии.
        Ваша задача - угадать год создания фотографии, используя слайдер. Игра состоит из
        10 раундов. После окончания игры вы сможете сохранить свой результат и, если он достаточно
        высок, попасть в таблицу лучших игроков. Удачи!
      </p>
      <button
        type="button"
      >
